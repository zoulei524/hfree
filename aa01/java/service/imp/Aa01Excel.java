...
public class Aa01Excel {
	 ...
	 * @throws Exception 
	 */
	public static void writeSheetData(String path, List<Map<String, Object>> aa01List) throws Exception {
		
		//表格列参数  宽度width，是否数字type，水平位置align，列名colname，列名描述label
		String tableConfigStr = "[{'colname':'aaa002','width':'120','label':'参数类别名称','align':'center','type':'String'},{'colname':'aaa005','width':'120','label':'参数值','align':'center','type':'String'},{'colname':'aaa105','width':'120','label':'参数值说明描述','align':'center','type':'String'},{'colname':'aaa104','width':'120','label':'参数类别代码是否可维护标志代码','align':'center','type':'String'},{'colname':'active','width':'120','label':'是否有效标志代码','align':'center','type':'String'},{'colname':'oldparam','width':'120','label':'上一版本参数值','align':'center','type':'String'}]";
		JSONArray tableConfig = JSON.parseArray(tableConfigStr);
		//新建excel工作簿
		Workbook workbook = new XSSFWorkbook();
		//新建sheet页
		Sheet sheet = workbook.createSheet("（aa01）".replaceAll("[/\\\\?*\\[\\]'']", ""));
		//表头样式
